...
import com.example.bible.databinding.FragmentJudgesBinding;

public class JudgesFragment extends Fragment {

    private FragmentJudgesBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentJudgesBinding.inflate(inflater, container, false);
