...
import com.example.bible.databinding.FragmentJohnBinding;

public class JohnFragment extends Fragment {

    private FragmentJohnBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentJohnBinding.inflate(inflater, container, false);
    ...
    public static void goToChapter(int c) {
        chapter = c;
        for (int i = 0; i < totalChapters; i++) {
            parentLayout.getChildAt(i).setVisibility(View.GONE);
        }
        parentLayout.getChildAt(c - 1).setVisibility(View.VISIBLE);
    }
